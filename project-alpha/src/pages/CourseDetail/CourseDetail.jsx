      ...
      <div className='h-[1610px] lg:w-[1024px] w-[100vw]'>
        <div className='grid gap-[40px]'>
          ...
          <div className='flex lg:w-[1024px] w-[100vw] sm:justify-between flex-col sm:flex-row'>
            <div className='lg:h-[200px] lg:w-[200px] w-[150px] h-[150px] rounded-[12px] bg-lime'></div>
            <div className='lg:w-[773px] sm:w-[70vw] sm:h-[181px] h-auto flex flex-col justify-between pr-5 lg:pr-0 '> 
              <div className='flex justify-between'>
                <div className='lg:text-[30px] text-[24px] font-montserrat font-bold flex'>Trainer A<BadgeCheck className='lg:mt-[8px] mt-[5px] ml-[10px] lg:h-[30px] lg:w-[30px] h-[24px] w-[24px]'/></div>
              ...
              <div>
                ...
                <div className='lg:text-[20px] text-[16px] font-montserrat font-medium'>Weight Training</div>
              </div>
            </div>
          </div>
