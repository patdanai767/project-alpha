...
const Login = () => {
  return (
    ...
    <div class="max-w-lg mx-auto  bg-white dark:bg-gray-900 rounded-2xl shadow-md px-20 py-7 flex flex-col items-center "> 
      
      <form action="#" class="w-full flex flex-col gap-4">
        <h1 class="text-4xl font-bold text-center text-blue-900 dark:text-gray-200 ">Login</h1>
          <h2 className=" text-center text-blue-900 dark:text-gray-200 mb-4 ">sign in to continue</h2>
          <div class="space-y-4">
              <div>
                <input name="Username" type="Username" autocomplete="Username" required class=" w-full rounded-3xl bg-gray-100 outline-blue-900 px-5 py-3" placeholder="Username" />
              </div>
            </div>
            <div>
                <input name="password" type="password" autocomplete="current-password" required class=" w-full rounded-3xl bg-gray-100 outline-blue-900 px-5 py-3" placeholder="Password" />
             </div>
          <div className="remember-forgot mb-3">
            <a href="#">Forgot password ?</a>
          </div>

          <button className=" text-center h-18  rounded-3xl bg-blue px-5 py-3 font-semibold text-white">Login</button>
          <div>
            <h3 class="text-center text-blue-900 dark:text-gray-200  ">Or Sign Up Using</h3>
          </div>

         <div className="space-x-6 flex justify-center mb-3">
          <button type="button" 
