  ...
  return (
    <div class="flex items-center justify-center min-h-screen from-purple-900 via-indigo-800 to-indigo-500 bg-gradient-to-br">
      <div class="max-w-lg mx-auto  bg-white dark:bg-gray-900 rounded-3xl shadow-md px-20 py-7 flex flex-col items-center">
        ...
        <h2 className=" text-blue-900 mb-8 font-bold">
        ...
        <form action="#" class="w-full flex flex-col gap-4">
          ...
          <input
            type="username"
            class=" w-full rounded-3xl bg-slate-200 outline-blue-900 px-5 py-3"
            placeholder=""
          />
          <label className="block mb-2 text-sm font-medium text-blue-900  dark:text-white">
            FullName
          ...
          <input
            type="email"
            class="mb-3 w-full rounded-3xl bg-slate-200 outline-blue-900 px-5 py-3"
            placeholder=""
          />
          <label className="block mb-2 text-sm font-medium text-blue-900  dark:text-white">
            Password
          ...
          <button
            type="password"
            class="mb-3 w-full rounded-3xl bg-blue-900  px-5 py-3 font-semibold text-white"
          >
            Login
          </button>
        </form>
