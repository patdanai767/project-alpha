  ...
  return (
    <div class="flex items-center justify-center min-h-screen bg-blue ">
      <div class="max-w-lg mx-auto  bg-white dark:bg-gray-900 rounded-2xl shadow-md px-20 py-7 flex flex-col items-center sm:max-xl ">
        <h1 class="text-4xl font-bold text-center text-blue-900 dark:text-gray-200 mb-4">
          Create new Account
        </h1>

        <div>
          <p className=" text-blue-900 mb-8 font-bold">
            Already Registered?
            <a
              href="/Login"
              class="no-underline hover:underline ...  text-lightblue"
            >
              {" "}
              Login
            </a>
        ...
        <form action="#" class="w-full flex flex-col gap-3">
          ...
          <input
            type="username"
            class=" w-80  ml-[0.5vh] rounded-3xl bg-slate-200 outline-blue-900 px-5 py-3"
            placeholder=""
          />
          <label className="block mb-2 text-sm font-medium text-blue-900  dark:text-white">
            FullName
          ...
          <input
            type="email"
            class="mb-3 w-80  ml-[0.5vh] rounded-3xl bg-slate-200 outline-blue-900 px-5 py-3"
            placeholder=""
          />
          <div>
            <label className="block mb-2 text-sm font-medium text-blue-900  dark:text-white ">
            ...
            <div className="flex  item-center justify-between">
              ...
              >
                <p
                  onClick={handleClick}
                  className="ml-[-7vh]  cursor-pointer  text-gray-400 hover:text-[black] duration-300"
                >
                  <LuEye></LuEye>
                </p>
              </button>
