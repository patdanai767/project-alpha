    ...
    <div className="h-full flex flex-wrap flex-col relative font-montserrat">
      <div className='  bg-sky  min-h-screen '>
        <div class="w-[190px] h-[44px] top-[204px] left-[208px] absolute ">
          <h1 class="font-semibold text-[36px]  text-center leading-{43.88px}  ">My Profile</h1>
        </div>
        <diV class=" h-[44px] mt-[312px] ml-[208px] gap-[32px] flex ">
          <div class="w-[1024px] h-[2090px] gap-[64px]  items-center ">
            <div class="w-[1024] h-[256] gap-[64px] flex ">
              <div class=" w-[200px] h-[256px] gap-16px ">
                <img class="bg-lime w-[200px] h-[200px] "></img>
                <div class="grow">
                  <div class="ml-2 mt-5 flex items-center gap-x-2">
                    <button type="button"
                      ...
                      data-hs-file-upload-trigger="">Upload photo
              ...
              <div class="w-[760px] h-[208px] gap-[32px]">
                <div class="w-[760px] h-[88px] gap-[8px] ">
                  ...
                  <div class="  w-[600] text-[20px] leading-{24.38px} font-semibold">Trainer Name
                  </div>

                  <input className="flex  items-center justify-between "
                  ...
                  <div class="mt-2 w-[600] text-[20px] leading-{24.38px} font-semibold ">Activity
                  </div>
            ...
            <div class="mt-[40px] w-[1024px] h-[88px] gap-[8px] flex ">
              <div class="w-[508px] h-[24px] gap-[8px]">
                ...
                <input className="bg-transparent w-[508px] h-[56px] rounded-[12px] border border-black padding-[16px] gap-[10px]"
                  id="hs-toggle-password"
                  type="Name"
                  name="Name"
            ...
            <div class="mt-[70px] w-[1024px] h-[165px] gap-[8px] flex ">
              <div class="w-[508px] h-[24px] gap-[8px]">
                ...
                <label for="large-input" class="text-[20px] text-black w-[600px] leading-{24.38} font-montserrat font-semibold ml-1.5"
                >About Me</label>
                <input 
                type="text" 
                id="" 
