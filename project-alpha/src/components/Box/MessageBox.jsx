      ...
      {sender ? (
        <div className="flex items-center h-fit">
          ...
          <div className="w-[40%] flex">
            <div className="border p-3 mx-1 my-2 bg-blue rounded-xl w-fit text-white">
              {text}
            </div>
        ...
        <div className="flex justify-end">
          <div className="w-[40%] flex justify-end">
            <div className="text-gray-300 content-end mb-1">{formatDate(date)}</div>
            <div className="border p-3 mx-1 my-2 bg-green rounded-xl text-white w-fit break-word">
              {text}
            </div>
          </div>
        </div>
