...
function Sidebar() {
  ...
  return (
      <div class="w-64 h-screen bg-gray-300 py-4 text-center fixed">
        ...
        {isOpen2 && (
          <div className='bg-gray-200 w-56 relative left-4 border-2 rounded-lg'>
          <div className='cursor-pointer hover:bg-gray-300'>1000 Baht/Course</div>
          <div className='cursor-pointer hover:bg-gray-300'>2000 Baht/Course</div>
          <div className='cursor-pointer hover:bg-gray-300'>3000 Baht/Course</div>
          <div className='cursor-pointer hover:bg-gray-300'>4000 Baht/Course</div>
        </div>
        )}

        <div className='bg-slate-50 h-[2px] w-[235px] mt-[25px] inline-flex'></div>

        <div className='text-3xl font-serif font-extrabold  mt-[16px] '>Catagory</div>
        <div className='rounded-full border-black border-2 w-5 h-5  text-black mt-4 ml-16 hover:border-gray-600 cursor-pointer' onClick={toggleGain}>
        ...
        <div className='rounded-full border-black border-2 w-5 h-5  text-black mt-4 ml-16 hover:border-gray-600 cursor-pointer' onClick={togglePerform}>
          <div className='ml-6 -mt-1 whitespace-nowrap'>performance </div>
          {isOpen4 && (
            <div className='rounded-full w-3 h-3 bg-black -mt-[18px] ml-[2px] hover:bg-gray-600'></div>
          )}
        </div>
        <div className='rounded-full border-black border-2 w-5 h-5  text-black mt-4 ml-16 hover:border-gray-600 cursor-pointer' onClick={toggleDiet}>
