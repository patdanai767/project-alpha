...
const Searchcard = ({title,description,price,duration,thumbnail,category}) => {
  return (
    <div className='ml-[150px] mt-[40px] flex'>
    <div className='border-[3px] border-gray-400 h-[400px] w-[1000px] hover:border-black rounded-md'>
      ...
      <div className='absolute border-black border-2 bg-lightblue h-[50px] w-[280px] ml-[680px] mt-[265px] rounded-lg hover:bg-green cursor-pointer'>
